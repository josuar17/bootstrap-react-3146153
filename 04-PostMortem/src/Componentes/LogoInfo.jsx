      ...
      <div className="container">
        ...
        <div className="row mb-5 pb-4 border-bottom border-white border-2">
          <div className="col-12 col-lg-6 text-center text-lg-start mb-4 mb-lg-0">
            <h1 className="fw-bolder text-white text-uppercase d-inline-block" style={{ fontSize: '3.5rem' }}>NUESTRO <span style={{ color: '#ff0000' }}>LOGO</span></h1>
          </div>
          <div className="col-12 col-lg-6 text-center text-lg-end ">
            <p className="text-white fw-bold text-center" style={{ fontSize: '0.9rem', color: '#ff0000', width:'100%' }}>Tipografía: <span style={{color:'black', fontWeight:'bolder', fontSize:'1rem'}}>"POST"</span> en negro y <span style={{color:'red', fontWeight:'bolder', fontSize:'1rem'}}>"MORTEM"</span> en rojo refuerzan el contraste entre ambos conceptos.</p>
          </div>
        </div>
        ...
        <div className="row justify-content-center pt-5">
          ...
          <div className="col-12 position-relative" style={{ maxWidth: '800px', minHeight: '600px', paddingTop: '50px' }}>
            ...
            <div className="d-none d-lg-flex justify-content-center position-absolute top-50 start-50 translate-middle" style={{ zIndex: 1 }}>
              <img src="/LOGO.png" className="img-fluid" style={{ width: '100%', maxWidth: '280px' }} />
            </div>
            
            <div className="d-lg-none d-flex justify-content-center mb-5">
              <img src="/LOGO.png" className="img-fluid" style={{ width: '100%', maxWidth: '200px' }} />
            </div>
            ...
            <div className="row d-lg-none text-center g-4">
                ...
                <div className="col-12">
                    <p className="fw-bold" style={{ color: '#ffffff' }}>Calavera dividida:</p>
                ...
                <div className="col-12">
                    <p className="fw-bold" style={{ color: '#ffffff' }}>Rama en el lado blanco:</p>
